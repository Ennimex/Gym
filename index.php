...
class Aplicacion {
    ...
    public function __construct() {
        ...
        $this->clase = isset($_GET['clase']) ? filter_input(INPUT_GET, 'clase', FILTER_SANITIZE_SPECIAL_CHARS) : 'controladorprincipal';
        $this->metodo = isset($_GET['metodo']) ? filter_input(INPUT_GET, 'metodo', FILTER_SANITIZE_SPECIAL_CHARS) : 'Publico';
    }
